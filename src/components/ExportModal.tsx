...
export function ExportModal({ acquirer, target, assumptions, results, onClose }: ExportModalProps) {
...
Generated by M&A Merger Simulator
  ...
  const handleDownload = () => {
    const content = exportFormat === 'txt' ? generateReport() : generateCSV();
    const mimeType = exportFormat === 'txt' ? 'text/plain' : 'text/csv';
    ...
    a.href = url;
    a.download = `merger-analysis-${acquirer.name}-${target.name}-${Date.now()}.${extension}`;
        ...
        <div className="modal-body">
          <div className="export-options">
            ...
            <div className="format-selector">
              ...
              >
                ...
                <span className="format-name">Text Report</span>
                <span className="format-desc">Formatted report for viewing</span>
              </button>
              <button
              ...
              >
                ...
                <span className="format-desc">Import into Excel</span>
              </button>
            </div>
          </div>
          ...
          <div className="export-preview">
            ...
            <pre className="preview-content">
              {exportFormat === 'txt' ? generateReport() : generateCSV()}
            </pre>
          </div>
        </div>
